        ...
        >
          ...
          <section className="subhero-section">
            <div className="row   mx-auto">
              {/* PART 1 */}
              <div className="col-8 subhero-section-part1 mt-5 text-center">
                <span className="subhero-section-part1-headtxt">
                  INVITATION FOR <span className="waltz-txt">WALTZ 2K23</span>{" "}
                </span>
                <span className="subhero-section-part1-bodytxt row mt-4 text-light text-start">
                  <span className="text1 mb-3">Dear {userName},</span>
                  <span className="text2 p-4">
                    {" "}
                    Warm greetings from the students of University Institute of
                    Technology! We hope this letter finds you in good health and
                    high spirits. We are excited to inform you about the
                    upcoming Cultural Fest Waltz 2k23, scheduled to take place
                    on 26th may 2023 to 28th may 2023 at our campus. As valued
                    members of our alumni community, we extend a heartfelt
                    invitation for you to join us in celebrating this vibrant
                    and diverse event. The Waltz 2k23 serves as a platform for
                    our current students to showcase their talents, creativity,
                    and cultural heritage through a wide range of performances,
                    exhibitions, and activities. It is an occasion where
                    students, faculty, staff, and alumni come together to foster
                    a sense of unity and pride in our college. By attending the
                    Waltz 2k23, you will have the opportunity to witness the
                    ...
                    you as role models. We kindly request you to RSVP by 25th
                    ...
                    than happy to assist you. Your support and presence at the
                    Cultural Fest will contribute to its success and strengthen
                    the bond between our alumni and our college community. We
                    truly value your continued association with University
                    Institute of Technology and look forward to your presence at
                    this joyful celebration. Thank you for considering our
                    invitation. We eagerly await your positive response.{" "}
                  </span>
