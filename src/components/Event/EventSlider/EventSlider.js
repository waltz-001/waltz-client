...
export default function EventSlider() {
  ...
  return (
    <div className="my-container" id="cardID">
      <div
        className={
          firstImageNo === 0 ? "navArrows navArrows-inactive" : "navArrows"
        }
        onClick={moveLeft}
        id="left"
      >
      ...
      {user.events
        ...
        .map((ev, i) => {
          if (i >= firstImageNo && i <= lastImageNo) {
            return <Event key={i} url={ev.imageUrl} />;
          } else {
            return null;
          }
          // console.log(ev)
      ...
      <div
        className={
          lastImageNo === user.events.length - 1
            ? "navArrows navArrows-inactive"
            : "navArrows"
        }
        onClick={moveRight}
        id="right"
