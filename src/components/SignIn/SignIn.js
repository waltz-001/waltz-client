          ...
          >
            <div className="row g-0">
              <div className="col-md-6 borde part1 shadow rounded">
                ...
                <span className="extra-txt d-flex align-items-center justify-content-center">Don't have an account? <a className="extra-txt-link" href="/">  Sign Up </a></span>
              </div>
              <div className="col-md-6 container borde part2 shadow rounded">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    ...
                    <span className="d-grid gap-2">
                      <span
                        className="borde mt-3 text-secondary d-flex mx-auto align-items-center justify-content-center"
                        type="button"
                        style={{ height: "3rem", width: "100%" }}
                      >
                        {" "}
                    ...
                    <span className="extra-txt-res align-items-center justify-content-center">Don't have an account? <a className="extra-txt-link" href="/">  Sign Up </a></span>
                  </p>
                </div>
              </div>
            </div>
